...
# (1) Convert pums to a survey object for regression fitting
# (2) Convert cps org to a survey object for regression fitting
...
#--------------------------------------------------------------------------
# Convert pums to a survey object for regression fitting
...
#--------------------------------------------------------------------------
# Convert cps org to a survey object for regression fitting

cps.list %<>% lapply( function(x) { x %<>% to_survey( ) } )
